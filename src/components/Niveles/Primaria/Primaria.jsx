...
import ep1 from '../../../images/secundaria/ep1.jpg'
    ...
    return(<Box>
        <Box className={styles.texto}>
            ...
            <Box className={styles.subTitle}>
                ...
                <Box><Typography>
                1° A 6° AÑO - DOBLE JORNADA (TURNO MAÑANA EN CASTELLANO, TURNO TARDE EN INGLES)
                    </Typography></Box>
            </Box>
            <Box><Typography>Se implementan estrategias concernientes al desarrollo de alumnos autónomos, responsables y solidarios. </Typography></Box>
            <Box><Typography>Contamos con actividades deportivas, artísticas, musicales y actorales.
